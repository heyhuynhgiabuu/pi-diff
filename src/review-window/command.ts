...
// Native Glimpse-powered /review-diff command (v0.6.4 pi-diff port of
...
export function registerReviewWindowCommand(pi: ExtensionAPI): void {
	...
	function closeActiveWindow(): void {
		...
		try {
			...
			// Closing is best-effort: the OS window may already be gone.
		}
	}
	...
	pi.registerCommand("review-diff", {
		description: "Open a native review window for git diff, commits, and file review",
